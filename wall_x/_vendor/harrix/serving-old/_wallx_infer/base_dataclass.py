...
class ComputedDict(dict):
    """Dict that registers compute rules and auto-fills None values on get."""
    ...
    def get(self, key, default=None):
        """Override get to support lazy computation."""
    ...
    def __getitem__(self, key):
        """Override [] to support lazy computation."""
...
class RobotStateActionData:
    ...
    def __post_init__(self):
        ...
        # Action rules: derive absolute RPY
    ...
    def get_agent_pos(self, obs_action_keys=None):
        ...
        for key in obs_action_keys:
            ...
            if state_key in self.data:
                ...
                if value is None:
                    # If still None after compute, use zero vector
