...
class Qwen2_5_VLVisionFlashAttention2(nn.Module):
    def __init__(self, config: Qwen2_5_VLConfig, dim: int, num_heads: int = 16) -> None:
        super().__init__()
...
class Qwen2_5_VLPreTrainedModel(AttentionsSelectorMixin, PreTrainedModel):
...
class Qwen2_5_VLFlashMaskAttention(Qwen2_5_VLAttention):
    ...
    def forward(
        ...
        if attention_mask is not None and attention_mask.shape[1] == 1:
            # attention_mask: (bsz, 1, q_len, 2) or (bsz, 1, q_len, 4)
        ...
        query_states_contiguous = query_states.contiguous()
        key_states_contiguous = key_states.contiguous()
        value_states_contiguous = value_states.contiguous()

        attn_output = flash_mask_attn_func(
            query_states_contiguous,
            key_states_contiguous,
            value_states_contiguous,
...
QWEN2_5_VL_ATTENTION_CLASSES = {
    ...
    "flash_mask": Qwen2_5_VLFlashMaskAttention,
}
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config, use_selective_recompute):
        super().__init__(config)
        self.visual = Qwen2_5_VisionTransformerPretrainedModel._from_config(
            config.vision_config, use_selective_recompute
        )
