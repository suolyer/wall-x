...
class OptimizerConfig:
    ...
    @property
    def use_dedicated_params(self) -> bool:
        """Whether this optimizer requires FSDP2-wrapped model to also have
        ``dmuon.dedicate_params()`` applied. Default False; overridden by
        DMuonConfig (the strategy passes this flag through to
        ``model.convert_to_fsdp``)."""
        return False
